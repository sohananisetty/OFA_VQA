...
Some custom parameters
 ...
 metadata = { "help" : "Whether to freeze the weight of the word vector of the encoder, since the enocder of the OFA model shares the weight of the word vector with the decoder, freeze_encoder will freeze the word vector. When freeze_word_embed=False, the word vector will be trained together" })
